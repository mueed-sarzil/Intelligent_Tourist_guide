...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Intelligent Tourist Guide</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="{{route('tour.places')}}" class="nav-link">Places</a></li>
            <li class="nav-item"><a href="https://www.booking.com" class="nav-link">Hotels</a></li>
            <li class="nav-item"><a href="https://www.shohoz.com/" class="nav-link">Bus</a></li>
